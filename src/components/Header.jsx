...
const socials = [
  {
    icon: faEnvelope,
    url: "mailto: iam@roymatar.com",
  },
  {
    icon: faGithub,
    url: "https://github.com/royMatar",
  },
  {
    icon: faLinkedin,
    url: "https://www.linkedin.com/in/roy-matar/",
  },
];
...
const Header = () => {
  ...
  const handleClick = (anchor) => () => {
    ...
    if (element) {
      ...
      setIsBurgerMenuOpen(false); // Close the burger menu after clicking a link
    }
  };
    ...
    >
      <Box color="white" maxWidth="1280px" margin="0 auto">
        ...
        >
          ...
          <nav>
            <HStack spacing={8}>
              {isBurgerMenuOpen || !isSmallScreen ? (
                <>
